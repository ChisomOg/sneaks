...
@Component({
  selector: 'app-men3',
  templateUrl: './men3.component.html',
  styleUrls: ['./men3.component.scss']
})
export class Men3Component implements OnInit {
  ...
  im = "assets/image/mi1.jpeg"
  im1 = "assets/image/mi2.jpeg"
  im2 = "assets/image/mi3.jpeg"
  im3 = "assets/image/mi4.jpeg"
...
showSlides(n: number){
  ...
  addCart(){
      const cart = new Cart('Jordan Air', 250, this.num, this.im);
      this.cartService.addCart(cart)
      this.router.navigateByUrl("/men3")
